...
// Add event listeners to the cities
cities.forEach((city) => {
...
function fetchWeatherData() {
    fetch(`http://api.weatherapi.com/v1/current.json?key=cb81ddb11fe448e894271711242806&q=${cityInput}`)
...
// Fetch the weather data for the default city on page load
fetchWeatherData();
